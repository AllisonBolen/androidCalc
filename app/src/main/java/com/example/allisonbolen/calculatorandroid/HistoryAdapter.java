...
import com.example.allisonbolen.calculatorandroid.HistoryFragment.OnListFragmentInteractionListener;
import com.example.allisonbolen.calculatorandroid.dummy.HistoryContent.HistoryItem;
                        ...
                        HistoryAdapter.FooterViewHolder>
 {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mP1 = view.findViewById(R.id.p1);
            mDateTime = view.findViewById(R.id.timestamp);
